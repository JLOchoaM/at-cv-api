...
import static com.jlochoam.atcvapi.exception.GlobalExceptionBody.ErrorDetails;
import static com.jlochoam.atcvapi.validator.ValidationUtils.*;
...
public class CvValidator implements Validator<CV> {
    ...
    private static final String INVALID_FORM = "is in an invalid format";
